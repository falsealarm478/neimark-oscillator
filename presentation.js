...
window.PresentationTranslations={
  ...
  'Источники':'Sources',
  'FPAllbook.pdf, § 8.3 «Осциллятор Неймарка», с. 75–76 — уравнение движения и отображение за полпериода. Файл предоставлен в задании; библиографические данные издания не уточнены.':'FPAllbook.pdf, § 8.3 “Neimark oscillator”, pp. 75–76 — equation of motion and half-period map. Supplied with the assignment; publication details have not been provided.',
  '«Некоторые основные требования к презентациям», с. 1 — требования к структуре и оформлению.':'“Some basic requirements for presentations”, p. 1 — structure and design requirements.',
...
<main id="title" class="view title-view">
  <div class="institution"><div class="emblem-placeholder"><span>МГУ</span><small>Эмблема МГУ</small></div><div><p>МГУ имени М. В. Ломоносова</p><h2>Факультет вычислительной математики и кибернетики</h2></div><div class="emblem-placeholder"><span>ВМК</span><small>Эмблема ВМК</small></div></div>
  <p class="asset-note">Место для официальной эмблемы</p>
  <section class="title-hero"><div class="title-copy"><div class="eyebrow">Учебная интерактивная презентация</div><h1>Осциллятор Неймарка<span>.</span></h1><p>Отрицательное трение. Непрерывное движение. Дискретные удары.</p><div class="title-actions"><button class="primary" data-view="laboratory">Презентация</button><button data-view="theory">Теория по теме</button><button data-view="authors">Авторы</button><button data-view="exit">Выход</button></div><p class="title-caption">Начните с движения — исследуйте его на графиках.</p></div><div class="hero-orbit" aria-hidden="true"><svg viewBox="0 0 400 400"><path class="orbit-grid" d="M20 200H380 M200 20V380"/><path class="orbit-line" d="M200 200 C200 180 230 180 235 202 C247 250 166 260 152 205 C130 120 258 110 279 197 C311 328 112 334 86 207 C47 17 334 28 348 191 C366 373 33 394 32 199"/><path class="orbit-jump" d="M200 44V218"/><circle cx="200" cy="218" r="9"/></svg><span>x · v</span></div></section>
...
<section class="sources panel"><h2>Источники</h2><ol><li>FPAllbook.pdf, § 8.3 «Осциллятор Неймарка», с. 75–76 — уравнение движения и отображение за полпериода. Файл предоставлен в задании; библиографические данные издания не уточнены.</li><li>«Некоторые основные требования к презентациям», с. 1 — требования к структуре и оформлению.</li><li><a href="https://github.com/falsealarm478/neimark-oscillator" target="_blank" rel="noopener">Исходный код проекта</a></li></ol></section></main>
<main id="authors" class="view reading-view" hidden><div class="eyebrow">Команда проекта</div><h1>Авторы работы</h1><p>МГУ имени М. В. Ломоносова</p><p>Факультет вычислительной математики и кибернетики</p><div class="author-grid"><article class="panel author-card"><div class="portrait"><span>АГ</span><small>Фотография не предоставлена</small></div><h2>Григорьев Александр Сергеевич</h2></article><article class="panel author-card"><div class="portrait"><span>СЖ</span><small>Фотография не предоставлена</small></div><h2>Журавлёва Светлана Викторовна</h2></article></div><section class="panel supervisor"><h2>Преподаватель-руководитель</h2><p>Ольга Александровна Чичигина</p></section></main>
